        ...
        <div class="row">
            ...
            <div class="col s12">
                <div class="container">
                    ...
                    <!-- Content Area Starts -->
                    <form action="{{ route('store_invoices')}}" method="POST">
                        @csrf
                            ...
                            <div class="datatable-search">
                                <div class="card">
                                    <div class="card-content">
                                        ...
                                        <h4>TOTAL <b class="total indigo-text">0.00</b></h4>
                                        <div class="row">
                                            <div class="col l3">
                                            ...
                                            <div class="col l3">
                                                ...
                                                <input type="text" placeholder="0.00" readonly value="{{ $orderCodes }}" name="code" class="indigo-text code">
                                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td><select name="product_id[]" required="" class="product_id browser-default">
                                                        ...
                                                        <?php
                                                            ...
                                                            $var = null;
                                                            if(!empty($stock)){
                                                            $var = $stock->where('prod_id', $product->id);
                                                            }
                                                            ...
                                                            echo $var;
                                                        ?>
                                                        <option data-available="{{ $var->first()->total }}" data-offer-qty="{{ $product->offer_quantity }}" data-price="{{ $product->wholesale_price }}" data-offer-price="{{ $product->offer_price }}" data-name="{{ $product->name }}" value="{{ $product->id }}">{{ $product->code }}</option>
                                                        @endforeach
                                                      </select>
                                                  </td>
                                                ...
                                                <b><td><input type="text" placeholder="" readonly="" value="" name="" class="available red-text bold-text"></td></b>
...
<script type="text/javascript">
    ...
    $('.add').click(function(){
        ...
        '<b><td><input type="text" placeholder="" readonly="" value="" name="" class="available red-text"></td></b>' +
