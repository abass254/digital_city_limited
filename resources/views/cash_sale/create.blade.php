                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col 3">
                                                ...
                                                <input type="text" placeholder="0.00" value="" name="amount_paid" required class="amount_paid">
                                            </div>
                                            <div class="col 3">
                                                <label for="">Balance</label>
                                                <input type="text" placeholder="" readonly="" value="" name="returning_change" required class="returning_change">
                                            </div>
                                            <div class="col 3">
