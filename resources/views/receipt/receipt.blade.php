            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="row invoice-date-number">
                        ...
                        <span class="invoice-number mr-1">Receipt No.</span>
                    ...
                    <div class="row mt-3 invoice-logo-title">
                        ...
                        <h4 class="indigo-text">Receipt</h4>
                    ...
                    <div class="invoice-product-details">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$sale->qty}}</td>
                                <td class="indigo-text right-align">{{ number_format($sale->total_amount, 2) }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                        </table>
                    ...
                    <div class="invoice-subtotal">
                        ...
                        <div class="col xl4 m7 s12 offset-xl3">
                            ...
                            <li class="display-flex justify-content-between">
                                <span class="invoice-subtotal-title">Gross Amount</span>
                                <h6 class="invoice-subtotal-value">Ksh.{{ number_format($sales->first()->gross_amount, 2) }}</h6>
                            </li>
                            <li class="display-flex justify-content-between">
                            ...
                            <li class="display-flex justify-content-between">
                                ...
                                <h6 class="invoice-subtotal-value red-text">Ksh.{{ number_format($sales->first()->amount_paid, 2) }}</h6>
                            </li>
                            <li class="display-flex justify-content-between">
                                <span class="invoice-subtotal-title">Balance</span>
                                <h6 class="invoice-subtotal-value red-text">Ksh.{{ number_format($sales->first()->returning_change, 2) }}</h6>
                            </li>
                            </ul>
                        </div>
                        </div>
